...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*LicenseAwareArgs)(nil), (*config.LicenseAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_LicenseAwareArgs_To_config_LicenseAwareArgs(a.(*LicenseAwareArgs), b.(*config.LicenseAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LicenseAwareArgs)(nil), (*LicenseAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LicenseAwareArgs_To_v1_LicenseAwareArgs(a.(*config.LicenseAwareArgs), b.(*LicenseAwareArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_LicenseAwareArgs_To_config_LicenseAwareArgs(in *LicenseAwareArgs, out *config.LicenseAwareArgs, s conversion.Scope) error {
	out.DefaultNamespace = in.DefaultNamespace
	return nil
}

// Convert_v1_LicenseAwareArgs_To_config_LicenseAwareArgs is an autogenerated conversion function.
func Convert_v1_LicenseAwareArgs_To_config_LicenseAwareArgs(in *LicenseAwareArgs, out *config.LicenseAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_LicenseAwareArgs_To_config_LicenseAwareArgs(in, out, s)
}

func autoConvert_config_LicenseAwareArgs_To_v1_LicenseAwareArgs(in *config.LicenseAwareArgs, out *LicenseAwareArgs, s conversion.Scope) error {
	out.DefaultNamespace = in.DefaultNamespace
	return nil
}

// Convert_config_LicenseAwareArgs_To_v1_LicenseAwareArgs is an autogenerated conversion function.
func Convert_config_LicenseAwareArgs_To_v1_LicenseAwareArgs(in *config.LicenseAwareArgs, out *LicenseAwareArgs, s conversion.Scope) error {
	return autoConvert_config_LicenseAwareArgs_To_v1_LicenseAwareArgs(in, out, s)
}
